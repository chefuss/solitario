...
Carta.prototype.compararCartas = function(array) {
  var cartaUno = document.querySelector(
    '[carta-numero="' + array[0][0] + '"][carta-palo="' + array[0][1] + '"]'
  );
  var cartaDos = document.querySelector(
    '[carta-numero="' + array[1][0] + '"][carta-palo="' + array[1][1] + '"]'
  );
